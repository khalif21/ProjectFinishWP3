...
<table class="table table-bordered table-striped" style="width: 100%; margin-bottom: 100px">
    <tr>
    ...
    <?php $no=1; foreach($jabatan as $j) : ?>
        <tr>
            ...
            <td>
                ...
                <a onclick="return confirm('Yakin menghapus data ini?')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/dataJabatan/deleteData/'.$j->id_jabatan) ?>">
