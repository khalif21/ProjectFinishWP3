    ...
    <label for="staticEmail" class="col-sm-3 col-form-label">Bulan</label>
    <div class="col-sm-9">
  ...
  <div class="form-group row">
    ...
    <select class="form-control" name="nama_pegawai">
        ...
        <button style="width:100%" type="submit" class="btn btn-primary"><i class="fas fa-print"></i> Cetak Slip Gaji</a></button>
    </div>
</div>
    </form>    
